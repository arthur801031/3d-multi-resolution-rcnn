...
class TwoStageDetector3D2ScalesOnePathwayOneRPN(BaseDetector, RPNTestMixin, BBoxTestMixin,
                       MaskTestMixin):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(TwoStageDetector3D2ScalesOnePathwayOneRPN, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(TwoStageDetector3D2ScalesOnePathwayOneRPN, self).init_weights(pretrained)
    ...
    def forward_train(self,
        ...
        if self.with_rpn:
            ...
            proposal_list_2, anchors_2 = self.rpn_head.get_bboxes(*proposal_inputs_2, img_meta_2=img_meta_2)
    ...
    def simple_test(self, imgs, img_metas, imgs_2, img_metas_2, proposals=None, rescale=False, test_cfg2=None):
        ...
        proposal_list_2 = self.simple_test_rpn(
        ...
        bboxes = torch.cat((bboxes, bboxes_2_refinement), 0)
