...
class TwoStageDetector3D(BaseDetector, RPNTestMixin, BBoxTestMixin,
                       MaskTestMixin):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(TwoStageDetector3D, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(TwoStageDetector3D, self).init_weights(pretrained)
